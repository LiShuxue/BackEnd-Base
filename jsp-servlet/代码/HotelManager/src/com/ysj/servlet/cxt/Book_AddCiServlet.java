...
public class Book_AddCiServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int result = 0;
		if( rws.bookCi(bookId)&&rws.ci(new Ci(0, roomid, roomType, roomPrice, discountPrice, pledge, customerName, cardType, cardId, customerPhone, arriveTime, leaveTime, checkinNum, operator, mId, mPrice, isBreakFirst, isClock, remark, 0))){
			result = 1;
		}
		response.sendRedirect("room/bookToCi.jsp?result=" + result);
	}
