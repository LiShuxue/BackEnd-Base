...
public class QueryRoom extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Integer roomCount = service.selectRooms().size();
		Integer count = 12;
		...
		List<Rooms> allList = service.selectRooms();
		...
		request.getRequestDispatcher("room/manageRoom.jsp").forward(request, response);
	}
