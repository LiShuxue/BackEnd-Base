...
*/
public class ChuangKouBiaoGeJTable extends javax.swing.JFrame {
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				ChuangKouBiaoGeJTable inst = new ChuangKouBiaoGeJTable();
	...
	private void initGUI() {
		try {
			setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
			{
				...
				{
					//注意，一定将TableModel改为DefaultTableModel,才可以用addRow()方法
